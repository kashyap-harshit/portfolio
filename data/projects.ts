...
export const projects: ProjectData[] = [
  {
    ...
    description:
      "A variational autoencoder (VAE) trained on a corpus of kick-drum samples. It learns a compact latent space of percussive sounds and samples from it to synthesize brand-new kicks. By interpolating between points in that latent space you can morph smoothly between punchy, boomy, and clicky textures, and the decoder reconstructs full-length waveforms from a handful of latent dimensions — turning sound design into exploring a learned distribution rather than tweaking oscillators by hand.",
    icon: "/kick-vae-1.png",
  ...
  },
  {
    ...
    description:
      "An audio oscillator VST plugin built with the JUCE framework — a real-time synthesizer voice with selectable waveforms, usable inside any DAW. It handles MIDI input with proper voice management, exposes parameters through an automatable host interface, and renders sine, saw, square, and triangle waves with anti-aliasing to keep the high end clean. Shipped as a standard VST3, it's a hands-on study of DSP and the plugin audio pipeline from note-on to sample output.",
    icon: "/vst-osc.png",
    techStack: ["C++", "JUCE"],
    links: [

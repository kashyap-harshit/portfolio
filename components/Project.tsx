...
function Project({ title, description, techStack, links }: ProjectData) {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <div className={`${caveat.className} border-t-2 border-[#8b1e3f] p-1 text-sm`}>
          Tech Stack := <b>{techStack.join(", ")}</b>
        </div>
